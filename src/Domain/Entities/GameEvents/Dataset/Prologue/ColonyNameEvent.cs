            ...
            return [
                ...
                new Slide(
                    ...
                    text: new string[]
                    {
                        ...
                        "Твоя задача — набрать команду, запустить добычу и сделать колонию прибыльной.",
                        "Стартового бюджета с запасом хватит на первые шаги. Всё, что осталось — твоя подпись.»"
                    },
        ...
        private static Slide GetDilemma()
        {
            return new Slide(
                ...
                text: new string[] {
                    ...
                    "без местных связей и знаний ты быстро утонешь в бумагах и интригах. " +
                    "Поверь, три месяца до приёмки пролетят незаметно.",
