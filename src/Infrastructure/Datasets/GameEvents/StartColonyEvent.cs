...
parameterChanges: [],
        ...
        private static Slide GetSlide9()
        {
            return new Slide(
                ...
                text: new string[]
                {
                    "Кассиус Морн аль-Хаким, 41 год. Финансист и юрист.",
        ...
        private static Slide GetSlide10()
        {
            return new Slide(
                ...
                text: new string[]
                {
                    "Лиен Чжан, 36 лет. Инженер станции.",
                    "Родилась в Циндао, в 16 лет улетела на Луну по программе RAS. Прошла путь от разнорабочей " +
        ...
        private static Slide GetSlide11()
        {
            return new Slide(
                ...
                text: new string[]
                {
                    "Дариус «Док» Уэбб, 47 лет. HR и миграционный контролёр.",
