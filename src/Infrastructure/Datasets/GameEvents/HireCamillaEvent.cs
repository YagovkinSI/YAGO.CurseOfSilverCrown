    ...
    public static class HireCamillaEvent
    {
        ...
        private static Slide GetSlideResume()
        {
            return new Slide(
                ...
                imageName: ImageSet.Camilla,
                text: [
                    "Вы просматриваете резюме, которое пришло через кадровое агентство Консорциума.",
                    "Камилла Селезнева, 34 года.",
                    "Опыт работы: 8 лет в Поясе. Помощник управляющего на станции Консорциума. " +
        ...
        private static Slide GetSlideAnswerAboutPreviousJob()
        {
            return new Slide(
                ...
                imageName: ImageSet.Camilla,
                text: [
                    "Камилла на мгновение задумывается, затем отвечает:",
