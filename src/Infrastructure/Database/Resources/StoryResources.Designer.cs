...
namespace YAGO.World.Infrastructure.Database.Resources {
    ...
    internal class StoryResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Совсем иное отношение у Каэлана — старший сын Илтарина никогда не упускал случая напомнить мальчику его место. Но Дари привык — после многих лет в этих стенах он знает свою роль... даже если иногда позволяет себе мечтать..
        /// </summary>
