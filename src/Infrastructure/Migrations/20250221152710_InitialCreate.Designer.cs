...
namespace YAGO.World.Infrastructure.Migrations
{
    ...
    [Migration("20250221152710_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YAGO.World.Infrastructure.Database.Models.Commands.Command", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("YAGO.World.Infrastructure.Database.Models.Domains.Organization", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("YAGO.World.Infrastructure.Database.Models.Errors.Error", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("YAGO.World.Infrastructure.Database.Models.EventDomains.EventObject", b =>
                {
            ...
            modelBuilder.Entity("YAGO.World.Infrastructure.Database.Models.Events.Event", b =>
                {
                    b.Property<int>("TurnId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("YAGO.World.Infrastructure.Database.Models.Relations.Relation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("YAGO.World.Infrastructure.Database.Models.Routes.Route", b =>
                {
            ...
            modelBuilder.Entity("YAGO.World.Infrastructure.Database.Models.Turns.Turn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("YAGO.World.Infrastructure.Database.Models.Units.Unit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("YAGO.World.Infrastructure.Database.Models.Users.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("YAGO.World.Infrastructure.Database.Models.Users.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("YAGO.World.Infrastructure.Database.Models.Commands.Command", b =>
                {
                    b.HasOne("YAGO.World.Infrastructure.Database.Models.Domains.Organization", "Domain")
                        .WithMany("Commands")
                        .HasForeignKey("DomainId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("YAGO.World.Infrastructure.Database.Models.Domains.Organization", "Target2")
                        .WithMany("ToDomain2Commands")
                        .HasForeignKey("Target2DomainId");

                    b.HasOne("YAGO.World.Infrastructure.Database.Models.Domains.Organization", "Target")
            ...
            modelBuilder.Entity("YAGO.World.Infrastructure.Database.Models.Domains.Organization", b =>
                {
                    b.HasOne("YAGO.World.Infrastructure.Database.Models.Domains.Organization", "Suzerain")
                        .WithMany("Vassals")
                        .HasForeignKey("SuzerainId");

                    b.HasOne("YAGO.World.Infrastructure.Database.Models.Users.User", "User")
                        .WithMany("Domains")
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("YAGO.World.Infrastructure.Database.Models.EventDomains.EventObject", b =>
                {
                    ...
                    b.HasOne("YAGO.World.Infrastructure.Database.Models.Turns.Turn", "Turn")
                        .WithMany("EventObjects")
                        .HasForeignKey("TurnId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("YAGO.World.Infrastructure.Database.Models.Events.Event", "EventStory")
                        .WithMany("EventObjects")
            ...
            modelBuilder.Entity("YAGO.World.Infrastructure.Database.Models.Relations.Relation", b =>
                {
                    b.HasOne("YAGO.World.Infrastructure.Database.Models.Domains.Organization", "SourceDomain")
                        .WithMany("Relations")
                        .HasForeignKey("SourceDomainId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("YAGO.World.Infrastructure.Database.Models.Domains.Organization", "TargetDomain")
            ...
            modelBuilder.Entity("YAGO.World.Infrastructure.Database.Models.Routes.Route", b =>
                {
                    b.HasOne("YAGO.World.Infrastructure.Database.Models.Domains.Organization", "FromDomain")
                        .WithMany("RoutesFromHere")
                        .HasForeignKey("FromDomainId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("YAGO.World.Infrastructure.Database.Models.Domains.Organization", "ToDomain")
            ...
            modelBuilder.Entity("YAGO.World.Infrastructure.Database.Models.Units.Unit", b =>
                {
                    ...
                    b.HasOne("YAGO.World.Infrastructure.Database.Models.Domains.Organization", "Position")
                        .WithMany("UnitsHere")
