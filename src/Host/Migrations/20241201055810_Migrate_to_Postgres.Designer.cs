...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YAGO.World.Host.Database.Commands.Command", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("YAGO.World.Host.Database.Domains.Domain", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("YAGO.World.Host.Database.Errors.Error", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("YAGO.World.Host.Database.EventDomains.EventObject", b =>
                {
            ...
            modelBuilder.Entity("YAGO.World.Host.Database.Events.Event", b =>
                {
                    b.Property<int>("TurnId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("YAGO.World.Host.Database.Relations.Relation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("YAGO.World.Host.Database.Routes.Route", b =>
                {
            ...
            modelBuilder.Entity("YAGO.World.Host.Database.Turns.Turn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("YAGO.World.Host.Database.Units.Unit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("YAGO.World.Host.Database.Users.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("YAGO.World.Host.Database.Users.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("YAGO.World.Host.Database.Commands.Command", b =>
                {
                    b.HasOne("YAGO.World.Host.Database.Domains.Domain", "Domain")
                        .WithMany("Commands")
                        .HasForeignKey("DomainId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("YAGO.World.Host.Database.Domains.Domain", "Target2")
                        .WithMany("ToDomain2Commands")
                        .HasForeignKey("Target2DomainId");

                    b.HasOne("YAGO.World.Host.Database.Domains.Domain", "Target")
            ...
            modelBuilder.Entity("YAGO.World.Host.Database.Domains.Domain", b =>
                {
                    b.HasOne("YAGO.World.Host.Database.Domains.Domain", "Suzerain")
                        .WithMany("Vassals")
                        .HasForeignKey("SuzerainId");

                    b.HasOne("YAGO.World.Host.Database.Users.User", "User")
                        .WithMany("Domains")
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("YAGO.World.Host.Database.EventDomains.EventObject", b =>
                {
                    ...
                    b.HasOne("YAGO.World.Host.Database.Turns.Turn", "Turn")
                        .WithMany("EventObjects")
                        .HasForeignKey("TurnId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("YAGO.World.Host.Database.Events.Event", "EventStory")
                        .WithMany("EventObjects")
            ...
            modelBuilder.Entity("YAGO.World.Host.Database.Relations.Relation", b =>
                {
                    b.HasOne("YAGO.World.Host.Database.Domains.Domain", "SourceDomain")
                        .WithMany("Relations")
                        .HasForeignKey("SourceDomainId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("YAGO.World.Host.Database.Domains.Domain", "TargetDomain")
            ...
            modelBuilder.Entity("YAGO.World.Host.Database.Routes.Route", b =>
                {
                    b.HasOne("YAGO.World.Host.Database.Domains.Domain", "FromDomain")
                        .WithMany("RoutesFromHere")
                        .HasForeignKey("FromDomainId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("YAGO.World.Host.Database.Domains.Domain", "ToDomain")
            ...
            modelBuilder.Entity("YAGO.World.Host.Database.Units.Unit", b =>
                {
                    ...
                    b.HasOne("YAGO.World.Host.Database.Domains.Domain", "Position")
                        .WithMany("UnitsHere")
