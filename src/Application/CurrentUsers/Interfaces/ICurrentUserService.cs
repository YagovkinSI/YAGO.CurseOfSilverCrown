...
namespace YAGO.World.Application.CurrentUsers.Interfaces
{
    public interface ICurrentUserService
    {
        ...
        Task<User> ConvertToPermanentAccount(ClaimsPrincipal userClaimsPrincipal, string userName, string? email, string password, CancellationToken cancellationToken);
