...
namespace YSI.CurseOfSilverCrown.Web.Migrations
{
    ...
    [Migration("20221224073941_Change_Parameters")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YSI.CurseOfSilverCrown.Core.Database.Models.GameWorld.Domain", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("YSI.CurseOfSilverCrown.Core.Database.Models.GameWorld.DomainRelation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("YSI.CurseOfSilverCrown.Core.Database.Models.GameWorld.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("YSI.CurseOfSilverCrown.Core.Database.Models.GameWorld.Route", b =>
                {
            ...
            modelBuilder.Entity("YSI.CurseOfSilverCrown.Core.Database.Models.GameWorld.Unit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("YSI.CurseOfSilverCrown.Core.Database.Models.Command", b =>
                {
                    b.HasOne("YSI.CurseOfSilverCrown.Core.Database.Models.GameWorld.Domain", "Domain")
                        .WithMany("Commands")
                        .HasForeignKey("DomainId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("YSI.CurseOfSilverCrown.Core.Database.Models.GameWorld.Person", "PersonInitiator")
                        .WithMany()
                        .HasForeignKey("PersonInitiatorId");

                    b.HasOne("YSI.CurseOfSilverCrown.Core.Database.Models.GameWorld.Domain", "Target2")
                        .WithMany("ToDomain2Commands")
                        .HasForeignKey("Target2DomainId");

                    b.HasOne("YSI.CurseOfSilverCrown.Core.Database.Models.GameWorld.Domain", "Target")
            ...
            modelBuilder.Entity("YSI.CurseOfSilverCrown.Core.Database.Models.GameWorld.Domain", b =>
                {
                    b.HasOne("YSI.CurseOfSilverCrown.Core.Database.Models.GameWorld.Person", "Person")
                        .WithMany("Domains")
                        .HasForeignKey("PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("YSI.CurseOfSilverCrown.Core.Database.Models.GameWorld.Domain", "Suzerain")
                        .WithMany("Vassals")
            ...
            modelBuilder.Entity("YSI.CurseOfSilverCrown.Core.Database.Models.GameWorld.DomainRelation", b =>
                {
                    b.HasOne("YSI.CurseOfSilverCrown.Core.Database.Models.GameWorld.Domain", "SourceDomain")
                        .WithMany("Relations")
                        .HasForeignKey("SourceDomainId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("YSI.CurseOfSilverCrown.Core.Database.Models.GameWorld.Domain", "TargetDomain")
            ...
            modelBuilder.Entity("YSI.CurseOfSilverCrown.Core.Database.Models.GameWorld.Route", b =>
                {
                    b.HasOne("YSI.CurseOfSilverCrown.Core.Database.Models.GameWorld.Domain", "FromDomain")
                        .WithMany("RouteFromHere")
                        .HasForeignKey("FromDomainId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("YSI.CurseOfSilverCrown.Core.Database.Models.GameWorld.Domain", "ToDomain")
            ...
            modelBuilder.Entity("YSI.CurseOfSilverCrown.Core.Database.Models.GameWorld.Unit", b =>
                {
                    ...
                    b.HasOne("YSI.CurseOfSilverCrown.Core.Database.Models.GameWorld.Domain", "Position")
                        .WithMany("UnitsHere")
